...
6.3. Создание канала без названия
...
### 7. Переключение между чатами

#### Позитивные кейсы:

7.1. Переключение между личными чатами  
...
7.2. Переключение между чатами и каналами  
...
### 8. Взаимодействие с UI-элементами
